...
Der Parameter \enquote{all} gibt an, welcher der 5 Folds, die das Framework automatisch erstellt, zur Validierung benutzt wird, während die anderen 4 dem Training dienen. Um Rechenzeit zu sparen benutzen wir \enquote{all}, was alle 5 Folds zum Training verwendet und wir die Performance später manuell anhand eines eigenen Testsplits evaluieren.
...
Nach dem Beenden des Trainings lassen wir uns von dem Framework die Predictions zu dem Train- und Testsplit erzeugen inklusive einer Auswertung der Genauigkeit je Sample und Klasse:
\begin{lstlisting}[language=bash]
